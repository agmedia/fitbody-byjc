...
@section('og')
    ...
    <meta property="og:image" content="{{ asset($sliders[0]->image) }}"/>
            ...
            <div class="section notopborder topmargin-sm bottommargin-sm noborder" style="color: #4e4e4e;">
                <div class="container clearfix">
                    <div class="col_one_third nobottommargin center bounceIn animated" data-animate="bounceIn">
                        ...
                        <div class="counter counter-lined"><span data-from="100" data-to="{{ number_format($products_data['amount'], 0, '', '') }}" data-refresh-interval="90" data-speed="2500" data-comma="true"></span>+</div>
                        <h5>KUNA ODOBRENO</h5>
                    </div>
                    <div class="col_one_third nobottommargin center bounceIn animated" data-animate="bounceIn" data-delay="200">
                        ...
                        <div class="counter counter-lined"><span data-from="0" data-to="{{ $products_data['count'] }}" data-refresh-interval="3" data-speed="2000"></span>+</div>
                    ...
                    <div class="col_one_third col_last nobottommargin center bounceIn animated" data-animate="bounceIn" data-delay="400">
                        ...
                        <div class="counter counter-lined"><span data-from="100" data-to="{{ $products_data['count'] * 5 }}" data-refresh-interval="25" data-speed="3500"></span>+</div>
