...
class Slider extends Model
{
    ...
    public function store()
    {
        $id = $this->insertGetId([
            ...
            'text_color'     => (isset($this->request->text_color) and $this->request->text_color == 'on') ? 'white' : 'black',
            'text_placement' => (isset($this->request->text_placement) and $this->request->text_placement == 'on') ? 'center' : 'left',
    ...
    public function resolveImage($id)
    {
        ...
        if ($slider->image && $slider->image != 'media/temp/slider/1.jpg') {
